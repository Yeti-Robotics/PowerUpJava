...
public class FalconPathPlanner {
	...
	public double[][] inject(double[][] orig, int numToInject) {
		...
		for (int i = 0; i < orig.length - 1; i++) {
			...
			for (int j = 1; j < numToInject + 1; j++) {
				...
				// calculate intermediate y points between j and j+1 original
				// points
	 ...
	 * @param robotTrackWidth
	 *            - width between left and right wheels of robot of skid steer
	 *            chassis.
	 */
	public void leftRight(double[][] smoothPath, double robotTrackWidth) {
		...
		for (int i = 0; i < smoothPath.length - 1; i++)
			gradient[i][1] = Math.atan2(smoothPath[i + 1][1] - smoothPath[i][1],
					smoothPath[i + 1][0] - smoothPath[i][0]);
	 ...
	 *            the robot.
	 * @param robotTrackWidth
	 *            - distance between left and right side wheels of a skid steer
	 *            chassis. Known as the track width.
	 */
	...
	public static void main(String[] args) {
		...
		double[][] waypoints = new double[][] { { 1, 1 }, { 5, 1 }, { 9, 12 }, { 12, 9 }, { 15, 6 }, { 19, 12 } };
	...
	public void poofExample() {
		...
		fig3.setTitle(
				"Top Down View of FRC Field (30ft x 27ft) \n shows global position of robot path, along with left and right wheel trajectories");
		...
		// Low Goals roughly 33 inch x 33 inch and 24.6 ft apart (inside to
		// inside)
		double[][] leftLowGoal = new double[][] { { 26.5, fieldWidth / 2 + 24.6 / 2 },
				{ 26.5, (fieldWidth) / 2 + 24.6 / 2 + 2.75 }, { 26.5 - 2.75, fieldWidth / 2 + 24.6 / 2 + 2.75 },
				{ 26.5 - 2.75, fieldWidth / 2 + 24.6 / 2 }, { 26.5, fieldWidth / 2 + 24.6 / 2 }, };

		double[][] rightLowGoal = new double[][] { { 26.5, fieldWidth / 2 - 24.6 / 2 },
				{ 26.5, fieldWidth / 2 - 24.6 / 2 - 2.75 }, { 26.5 - 2.75, fieldWidth / 2 - 24.6 / 2 - 2.75 },
				{ 26.5 - 2.75, fieldWidth / 2 - 24.6 / 2 }, { 26.5, fieldWidth / 2 - 24.6 / 2 }, };
		...
		double[][] CheesyPath = new double[][] { { 7, 16 }, { 11, 16 }, { 17, 28 }, { 23, 28 }, };
